========================================================================
    APPLICATION CONSOLE : Vue d'ensemble du projet CalculatriceProbaPoker
========================================================================

AppWizard a créé cette application CalculatriceProbaPoker pour vous.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application CalculatriceProbaPoker.


CalculatriceProbaPoker.vcxproj
...
CalculatriceProbaPoker.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) CalculatriceProbaPoker.pch et un fichier de type précompilé nommé StdAfx.obj.
